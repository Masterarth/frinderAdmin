...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-8">
                <?= $this->tag->linkTo(['place/new', 'Neuer Place', 'class' => 'btn btn-primary']) ?>
            </div>
        </div>
    </div>
</div>
<div class="card">
    <div class="card-body">
        ...
        <hr />
        <?php foreach ($page->items as $place) { ?>
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination justify-content-center">
            <li class="page-item <?php if ($page->current == $page->before) { ?>disabled<?php } ?>"><a class="page-link" tabindex="-1" href="/place/index/<?= $page->before ?>"><span aria-hidden="true">&larr;</span> Zurück</a></li>
            <li class="page-item"><a class="page-link"><?= $page->total_items ?> Places</a></li>
            <li class="page-item <?php if ($page->current >= $page->next) { ?>disabled<?php } ?>"><a class="page-link" href="/place/index/<?= $page->next ?>">Weiter <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
    </nav>
</div>