<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-9">
                <?= $this->tag->linkTo(['place/index', 'Zurück', 'class' => 'btn btn-primary']) ?>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <form method="post" action="/place/save">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="gid" name="gid" placeholder="Google Place ID" autocomplete="off" value="<?= $place->gid ?>" <?php if (isset($place->gid)) { ?>readonly<?php } ?>  tabindex="2">
            </div>
            <div class="form-group">
